...
$('.slider').each(function () {
    ...
    function advance() {
        ...
        currentPage.innerText = currentIndex
        totalPages.innerText = $slides.length
...
var swiper = new Swiper('.swiper-container', {
    slidesPerView: windowWidth > 370 ? 1.2 : 1,
    spaceBetween: 30,
    autoplay: {
        delay: 2500,
...
var swiper = new Swiper('.swiper-container2', {
    slidesPerView: windowWidth < 1024 ? windowWidth > 350 ? 2 : 1 : 3,
    spaceBetween: 30,
    autoplay: {
        delay: 2500,
        disableOnInteraction: false,
